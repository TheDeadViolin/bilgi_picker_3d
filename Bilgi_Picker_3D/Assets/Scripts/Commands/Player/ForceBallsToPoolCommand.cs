...
namespace Commands.Player
{
    public class ForceBallsToPoolCommand : ICommand
    {
        ...
        {
            //throw mew System.NotImplementedException();
        }
        ...
        public void Execute()
        {
            ...
            foreach (var ball in ballColliderList)
            {
                ...
                rb.AddForce(new Vector3(0, _movementData.ForwardForceCounter, _movementData.ForwardForceCounter), ForceMode.Impulse);

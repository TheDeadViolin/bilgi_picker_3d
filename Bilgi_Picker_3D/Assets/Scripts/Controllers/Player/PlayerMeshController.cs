...
namespace Controllers.Player
{
    public class PlayerMeshController : MonoBehaviour
    {
        ...
        internal void ShowUpText()
        {
            ...
            scaleText.rectTransform.DOAnchorPosY(.85f, .65f).SetRelative(true).SetEase(Ease.OutBounce).OnComplete(() => scaleText.rectTransform.DOAnchorPosY(-.85f, .65f).SetRelative(true));
        }
